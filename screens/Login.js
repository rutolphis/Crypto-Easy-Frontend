        ...
        <View style={styles.container}>
            ...
            <Form>
              <Item stackedLabel>
                ...
                <Input placeholder='johndoe@gmail.com' onChangeText={(val) => {setEmail(val);setCss('none')}}/>
              </Item>
              <Item stackedLabel last>
                <Label style={styles.loginInput}>Password</Label>
                <Input secureTextEntry={true} placeholder='********' onChangeText={(val) => {setPassword(val);setCss('none')}} />
              </Item>
              <Button block light style={styles.button} onPress={handleSignIn}>
                <Text style={styles.button}>Sign In</Text>
              </Button>
            </Form>
            <Text style={{display: css ,color: 'red', marginBottom: 10, fontSize: 16}}>{loginResult}</Text>
